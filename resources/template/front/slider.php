						...
						<ul>
							<li data-transition="fade">
								...
								<div class="tp-caption main-label"
									...
									style="z-index: 5"
									data-mask_in="x:0px;y:0px;">Mama Cham's Home Cooked Meal</div>
								...
								<div class="tp-caption bottom-label"
									...
									data-start="2000"
									style="z-index: 5"
									data-transform_in="y:[100%];opacity:0;s:500;" style="font-size: 1.2em;">Best Place to get that homecooked meals</div>

								<a class="tp-caption btn btn-md btn-primary"
									data-hash
									data-hash-offset="85"
									href="shop-landing.php?id=1"
									data-x="left" data-hoffset="25"
									...
									data-transform_out="opacity:0;s:500;"
									style="z-index: 5"
									data-mask_in="x:0px;y:0px;">Order Now <i class="fa fa-exclamation"></i></a>

							</li>
							<li data-transition="fade">
								<img src="img1/Slider-food-2.jpg"  
									alt=""
									data-bgposition="center center" 
									data-bgfit="cover" 
									data-bgrepeat="no-repeat"
