...
<div class="form-group">
    ...
    <div class="form-group row">
      ...
      <div class="col-xs-3">
        ...
        <input type="number" placeholder="RM" name="product_price" class="form-control" size="60" value="<?php echo $product_price; ?>">
      </div>
...
<!-- Product Tags Add them if you have em
    ...
    <div class="form-group">
        ...
        <img src="resources/<?php echo $product_image; ?>" alt="" width="100" >
