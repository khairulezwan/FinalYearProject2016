...
<?php include (TEMPLATE_BACK . DS . "header.php") ?> <!--header here-->
...
?>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
				...
				if($_SERVER['REQUEST_URI'] == "/mamacham.com/admin-index.php"){
...
<?php include (TEMPLATE_BACK . DS . "footer.php") ?> <!--footer here-->
